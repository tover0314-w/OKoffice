...
import { OKofficeClient } from "./client.js";
import type { OKofficeFetch } from "./client.js";
...
export async function runCli(
  ...
  try {
    ...
    const client = new OKofficeClient({ baseUrl, fetch: runtime.fetch });
    if (command === "tools") {
...
function helpText(): string {
  return [
    "okoffice-node: TypeScript/Node client for a local OKoffice REST server",
    "",
    "Commands:",
    "  okoffice-node tools [--base-url URL]",
    "  okoffice-node run TOOL --payload '{...}' [--base-url URL]",
    ...
    "  okoffice-node n-up report.pdf --per-sheet 2 -o report.n-up.pdf",
    "  okoffice-node booklet report.pdf -o report.booklet.pdf",
    "  okoffice-node metadata-update-outline report.pdf --outline outline.json -o outlined.pdf",
    "  okoffice-node inspect PATH [--base-url URL]",
    "  okoffice-node inspect-pages PATH [--pages 1-3] [--render-check]",
    "  okoffice-node inspect-health FILE",
    "  okoffice-node workflow-plan --goal GOAL [--input-path FILE]",
    "  okoffice-node workflow-run --payload '{...}' [--binding KEY=VALUE] [--dry-run]",
    "  okoffice-node workflow-report --payload '{...}' [-o report.md]",
    "  okoffice-node createpdf --html '<main>...</main>' --pdf-output out.pdf [--html-output out.html --artifact-dir audit --bundle-output bundle.zip --renderer-backend auto]",
    "  okoffice-node createpdf --context-packet context.packet.json --profile technical_audit --pdf-output out.pdf [--html-output out.html --artifact-dir audit --bundle-output bundle.zip --renderer-backend auto]",
    "  okoffice-node workflow-createpdf --html '<main>...</main>' --pdf-output out.pdf [--html-output out.html --artifact-dir audit --bundle-output bundle.zip --renderer-backend auto]",
    "  okoffice-node workflow-research-deck --brief brief.json [--evidence evidence.json] [--html-output deck.html --pdf-output deck.pdf] [--execute --artifact-dir workflow-artifacts]",
    "  okoffice-node authoring-plan --brief brief.json",
    "  okoffice-node research-plan --brief brief.json",
    "  okoffice-node research-source-cards --sources sources.json [--brief brief.json]",
    "  okoffice-node research-evidence-cards --source-cards source-cards.json",
    "  okoffice-node design-tokens [--theme consulting] [--color primary_color=#123456]",
    "  okoffice-node storyboard-plan --brief brief.json [--authoring-plan route.json] [--evidence evidence.json]",
    "  okoffice-node pages-write --brief brief.json --storyboard storyboard.json [--evidence evidence.json] [--design-tokens tokens.json]",
    "  okoffice-node pages-revise --page-document pages.json [--revision '{...}' --revisions revisions.json]",
    "  okoffice-node create-html-package --page-document pages.json|--html '<main>...</main>'|--html-file page.html --html-output deck.html [--title TITLE]",
    "  okoffice-node qa-visual-report --input deck.pdf [--expected-page-count 8] [--html-package-manifest deck.html-manifest.json]",
    "  okoffice-node context-build --text TEXT --file FILE --link LINK --item-json '{...}' -o context.packet.json",
    "  okoffice-node context-ingest --file FILE|--text TEXT|--link LINK [-o context-item.json] [--role ROLE] [--label LABEL] [--transcript-path PATH]",
    "  okoffice-node context-web-capture URL [-o context-item.json] [--label LABEL] [--max-bytes BYTES]",
    "  okoffice-node context-packet --item-json context-item.json --file FILE --link LINK -o context.packet.json",
    "  okoffice-node context-classify context.packet.json [--profile technical_audit] [-o context.classification.json]",
    "  okoffice-node code-snapshot src/service.ts [--line-start 1 --line-end 20] [-o code.context-item.json]",
    "  okoffice-node data-profile metrics.csv [--sheet Sheet1] [-o data.context-item.json]",
    "  okoffice-node context-image-analyze scan.png [--language eng] [--skip-ocr]",
    "  okoffice-node target-profiles [-o profiles.json]",
    "  okoffice-node target-validate --target-profile '{...}' [-o validation.json]",
    "  okoffice-node compose-plan context.packet.json --profile technical_audit [-o composition.plan.json]",
    "  okoffice-node compose-render-ir composition.plan.json -o report.pdf",
    "  okoffice-node compose-from-context context.packet.json --profile technical_audit -o report.pdf [--renderer html --html-output report.html]",
    "  okoffice-node compose-add-code-block report.pdf --code 'print(1)' --source-ref ctx_code -o report.code.pdf",
    "  okoffice-node compose-add-table report.pdf --columns metric,value --row latency_ms,42 -o report.table.pdf",
    "  okoffice-node compose-add-figure report.pdf --image diagram.png --source-ref ctx_image -o report.figure.pdf",
    "  okoffice-node compose-add-appendix report.pdf --markdown '## Sources' --source-ref ctx_code -o report.appendix.pdf",
    "  okoffice-node compose-add-citation report.pdf --source https://example.com --quote 'Claim text' --source-ref ctx_web -o report.citation.pdf",
    "  okoffice-node compose-add-media-reference report.pdf --media meeting.mp3 --media-kind audio --transcript-excerpt '00:00 Kickoff' --source-ref ctx_audio -o report.media.pdf",
    "  okoffice-node compose-add-slide report.pdf --title 'Review Slide' --body 'Decision evidence' --source-ref ctx_slide -o report.slide.pdf",
    "  okoffice-node evidence-coverage-report report.composition.json [-o coverage.json]",
    "  okoffice-node evidence-map-sources [report.composition.json] [--context-packet context.packet.json] [--blocks blocks.json] [-o source-map.json]",
    "  okoffice-node evidence-cite-claims --claims claims.json [--source-map source-map.json] [-o citations.json]",
    "  okoffice-node evidence-context-packet-report context.packet.json -o context-report.pdf [--report-output context-report.json]",
    "  okoffice-node artifact-manifest --file OUT.pdf --file OUT.composition.json [-o artifacts.json]",
    "  okoffice-node artifact-graph --manifest artifacts.json [-o artifact-graph.json]",
    "  okoffice-node artifact-source-map --composition OUT.composition.json [--context-packet context.packet.json] [-o artifact-source-map.json]",
    "  okoffice-node export-bundle --file OUT.pdf --file OUT.composition.json -o audit-bundle.zip",
    "  okoffice-node verify-bundle audit-bundle.zip",
    "  okoffice-node patch-plan report.pdf --operations '{...}' -o patch.json [--artifact-graph artifact-graph.json]",
    "  okoffice-node patch-preview patch.json [-o preview.json]",
    "  okoffice-node patch-apply patch.json -o patched.pdf",
    "  okoffice-node patch-verify patch.json patched.pdf",
    "  okoffice-node image-to-pdf IMAGE... -o OUT.pdf",
    "  okoffice-node reorder-pages FILE --order 3,1,2 -o OUT.pdf",
    "  okoffice-node insert-blank-pages FILE --after-page 1 -o OUT.pdf",
    "  okoffice-node compress FILE -o OUT.pdf",
    "  okoffice-node repair FILE -o OUT.pdf",
    "  okoffice-node remove-unused-objects FILE -o OUT.pdf",
    "  okoffice-node validate-pdfa FILE",
    "  okoffice-node subset-fonts FILE -o OUT.pdf",
    "  okoffice-node to-pdfa FILE -o OUT.pdf [--profile PDF/A-2b]",
    "  okoffice-node html-to-pdf input.html -o OUT.pdf",
    "  okoffice-node render-html-package report.html-manifest.json -o OUT.pdf [--renderer-backend auto|local_html_package_fallback|browser_chromium]",
    "  okoffice-node url-to-pdf https://example.com -o OUT.pdf",
    "  okoffice-node docx-to-pdf report.docx -o OUT.pdf",
    "  okoffice-node pptx-to-pdf deck.pptx -o OUT.pdf",
    "  okoffice-node xlsx-to-pdf metrics.xlsx -o OUT.pdf",
    "  okoffice-node pdf-to-html FILE -o OUT.html [--pages 1-3]",
    "  okoffice-node pdf-to-docx FILE -o OUT.docx [--pages 1-3]",
    "  okoffice-node pdf-to-pptx FILE -o OUT.pptx [--pages 1-3]",
    "  okoffice-node pdf-to-xlsx FILE -o OUT.xlsx [--pages 1-3]",
    "  okoffice-node security-protect FILE --password PASS -o OUT.pdf [--owner-password OWNER]",
    "  okoffice-node security-encrypt FILE --password PASS -o OUT.pdf [--owner-password OWNER]",
    "  okoffice-node security-unlock-authorized FILE --password PASS -o OUT.pdf",
    "  okoffice-node security-decrypt-authorized FILE --password PASS -o OUT.pdf",
    "  okoffice-node security-sign FILE -o OUT.pdf [--secret SECRET]",
    "  okoffice-node security-verify-signature FILE --signature FILE.signature.json [--secret SECRET]",
    "  okoffice-node security-malware-scan FILE",
    "  okoffice-node security-sanitize FILE -o OUT.pdf",
    "  okoffice-node security-redact FILE --region '{\"page\":1,\"bbox\":[60,700,280,760]}' -o OUT.pdf",
    "  okoffice-node security-verify-redaction FILE --search-term SECRET",
    "  okoffice-node watermark FILE --text TEXT -o OUT.pdf",
    "  okoffice-node page-numbers FILE -o OUT.pdf",
    "  okoffice-node add-shape FILE --shape rectangle --page 1 --x 72 --y 640 --width 120 --height 40 -o OUT.pdf",
    "  okoffice-node underline FILE --page 1 --bbox 72,640,180,656 -o OUT.pdf",
    "  okoffice-node strikeout FILE --page 1 --bbox 72,640,180,656 -o OUT.pdf",
    "  okoffice-node freehand-draw FILE --page 1 --points '[[72,680],[120,700]]' -o OUT.pdf",
    "  okoffice-node resize-pages FILE --width 612 --height 792 -o OUT.pdf",
    "  okoffice-node add-margin FILE --margin 36 -o OUT.pdf",
    "  okoffice-node underlay FILE --text DRAFT -o OUT.pdf",
    "  okoffice-node validate FILE [--expected-pages N]",
    "  okoffice-node render-check FILE [--pages 1-3]",
    "  okoffice-node blank-page-check FILE [--pages 1-3]",
    "  okoffice-node redaction-check FILE [--search-term SECRET]",
    "  okoffice-node extract-images FILE [--pages 1-3] [--out-dir DIR]",
    "  okoffice-node extract-fonts FILE [--pages 1-3]",
    "  okoffice-node parse-lite FILE",
    "  okoffice-node semantic-diff BEFORE.pdf AFTER.pdf [--pages 1-3]",
    "  okoffice-node version-report BEFORE.pdf AFTER.pdf [-o report.md]",
    "  okoffice-node compare-visual-diff BEFORE.pdf AFTER.pdf [--pages 1-3]",
    "  okoffice-node visual-diff BEFORE.pdf AFTER.pdf [--max-difference-ratio 0.001]",
    "  okoffice-node parse-figures FILE [--pages 1-3]",
    "  okoffice-node parse-formulas FILE [--pages 1-3]",
    "  okoffice-node parse-charts FILE [--pages 1-3]",
    "  okoffice-node parse-references FILE [--pages 1-3]",
    "  okoffice-node forms-create --field '{\"name\":\"name\",\"label\":\"Name\"}' -o form.pdf",
    "  okoffice-node forms-import-data form.pdf --data '{\"name\":\"Ada\"}' -o filled.pdf",
    "  okoffice-node forms-validate filled.pdf --required-field name",
    "  okoffice-node ocr scan.png --language eng",
    "  okoffice-node ocr-searchable-pdf scan.pdf -o searchable.pdf --language eng",
    "  okoffice-node ocr-scan-to-pdf scan.png -o scan.pdf",
    "  okoffice-node ocr-despeckle scan.pdf -o despeckled.pdf",
    "  okoffice-node ocr-remove-existing scan.pdf -o no-ocr.pdf",
    "  okoffice-node ocr-multilingual scan.pdf --language eng --language chi_sim -o ocr.pdf",
    "  okoffice-node pdf-to-json FILE -o OUT.json",
    "  okoffice-node pdf-to-markdown FILE -o OUT.md",
    "  okoffice-node rag-ingest FILE --index INDEX.json",
    "  okoffice-node rag-query INDEX.json --query QUERY",
    "  okoffice-node rag-chat FILE --question QUERY",
    "  okoffice-node rag-search INDEX.json --query QUERY",
    "  okoffice-node rag-cite-answer INDEX.json --answer ANSWER",
    "  okoffice-node rag-highlight-sources INDEX.json --answer ANSWER -o OUT.pdf",
    "  okoffice-node rag-export-report INDEX.json --question QUERY -o OUT.pdf",
    "  okoffice-node create-text --text TEXT -o OUT.pdf [--title TITLE]",
    "  okoffice-node create-markdown --markdown '# Title' -o OUT.pdf",
    "  okoffice-node create-markdown --markdown-file input.md -o OUT.pdf",
    "  okoffice-node create-from-prompt --prompt TEXT -o OUT.pdf [--template research_brief] [--color primary=#4f46e5]",
    "  okoffice-node create-templates",
    "  okoffice-node create-template-packs [-o packs.json]",
    "  okoffice-node create-validate-template-pack PACK.json [-o validation.json]",
    "  okoffice-node create-plan-template-pack PACK.json --profile technical_audit --context-packet context.packet.json --planned-output OUT.pdf [-o plan.json]",
    "  okoffice-node create-agent PACK.json --profile technical_audit --context-packet context.packet.json -o OUT.pdf [--plan-output plan.json] [--coverage-output coverage.json] [--context-classification-output classification.json] [--context-report-output context-report.pdf] [--bundle-output audit-bundle.zip]",
    "  okoffice-node create-from-template-pack PACK.json --template board_audit -o OUT.pdf [--color-scheme executive_blue] [--context-packet context.packet.json] [--renderer html --html-output OUT.html]",
    "  okoffice-node create-template-preview --template invoice -o preview.pdf",
  ].join("\n");
}
