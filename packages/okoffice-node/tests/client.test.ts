...
import { OKofficeClient } from "../src/index.js";
import type { OKofficeFetch } from "../src/index.js";
...
test("OKofficeClient lists tools from the local REST API", async () => {
  ...
  const calls: string[] = [];
  const client = new OKofficeClient({
...
test("OKofficeClient runs text-to-PDF with the expected payload", async () => {
...
test("OKofficeClient exposes okoffice worker status helper", async () => {
...
test("OKofficeClient exposes deck presentation validation helper", async () => {
  const calls: Array<{ url: string; body: unknown }> = [];
...
test("OKofficeClient exposes word document validation helper", async () => {
  const calls: Array<{ url: string; body: unknown }> = [];
  const validationResult: ToolResult = {
...
test("OKofficeClient exposes target profile helpers", async () => {
  const calls: Array<{ url: string; body: unknown }> = [];
...
test("OKofficeClient exposes context ingest and packet helpers", async () => {
  const calls: Array<{ url: string; body: unknown }> = [];
  const client = new OKofficeClient({
    baseUrl: "http://agentpdf.test",
    fetch: async (input: string | URL, init?: RequestInit) => {
...
test("OKofficeClient exposes page count, page info, and security metadata helpers", async () => {
  const calls: Array<{ url: string; body: unknown }> = [];
  const client = new OKofficeClient({
    baseUrl: "http://agentpdf.test",
    fetch: async (input: string | URL, init?: RequestInit) => {
...
test("OKofficeClient exposes PDF optimization, font, and edit helpers", async () => {
  const calls: Array<{ url: string; body: unknown }> = [];
  const client = new OKofficeClient({
    baseUrl: "http://agentpdf.test",
    fetch: async (input: string | URL, init?: RequestInit) => {
...
test("OKofficeClient exposes compare and semantic parse helpers", async () => {
  const calls: Array<{ url: string; body: unknown }> = [];
  const client = new OKofficeClient({
    baseUrl: "http://agentpdf.test",
    fetch: async (input: string | URL, init?: RequestInit) => {
...
test("OKofficeClient exposes forms and OCR helpers", async () => {
  const calls: Array<{ url: string; body: unknown }> = [];
  const client = new OKofficeClient({
    baseUrl: "http://agentpdf.test",
    fetch: async (input: string | URL, init?: RequestInit) => {
...
test("OKofficeClient exposes conversion, PDF/A, and security helpers", async () => {
  const calls: Array<{ url: string; body: unknown }> = [];
  const client = new OKofficeClient({
    baseUrl: "http://agentpdf.test",
    fetch: async (input: string | URL, init?: RequestInit) => {
...
test("OKofficeClient exposes context classify helper", async () => {
  let postedBody: unknown;
  const client = new OKofficeClient({
    baseUrl: "http://agentpdf.test",
    fetch: async (input: string | URL, init?: RequestInit) => {
...
test("OKofficeClient exposes code snapshot and data profile helpers", async () => {
  const calls: Array<{ url: string; body: unknown }> = [];
  const client = new OKofficeClient({
    baseUrl: "http://agentpdf.test",
    fetch: async (input: string | URL, init?: RequestInit) => {
...
test("OKofficeClient exposes compose plan and render IR helpers", async () => {
  const calls: Array<{ url: string; body: unknown }> = [];
  const client = new OKofficeClient({
    baseUrl: "http://agentpdf.test",
    fetch: async (input: string | URL, init?: RequestInit) => {
...
test("OKofficeClient exposes compose block helpers", async () => {
  const calls: Array<{ url: string; body: unknown }> = [];
  const toolResult = (tool: string): ToolResult => ({
    job_id: `job_${tool}`,
    status: "succeeded",
...
test("OKofficeClient exposes template pack helpers", async () => {
  const calls: Array<{ url: string; body: unknown }> = [];
  const client = new OKofficeClient({
    baseUrl: "http://agentpdf.test",
    fetch: async (input: string | URL, init?: RequestInit) => {
...
test("OKofficeClient exposes authoring workflow helpers", async () => {
  const calls: Array<{ url: string; body: unknown }> = [];
  const client = new OKofficeClient({
    baseUrl: "http://agentpdf.test",
    fetch: async (input: string | URL, init?: RequestInit) => {
...
test("OKofficeClient types workflowCreatePdf audit summary usage", async () => {
  const client = new OKofficeClient({
    baseUrl: "http://agentpdf.test",
    fetch: async () =>
      jsonResponse({
...
test("OKofficeClient types renderHtmlPackage backend usage", async () => {
  let postedBody: unknown;
  const client = new OKofficeClient({
    baseUrl: "http://agentpdf.test",
...
test("OKofficeClient exposes artifact bundle export helper", async () => {
  let postedBody: unknown;
  const client = new OKofficeClient({
    baseUrl: "http://agentpdf.test",
    fetch: async (input: string | URL, init?: RequestInit) => {
...
test("OKofficeClient exposes artifact manifest helper", async () => {
  let postedBody: unknown;
  const client = new OKofficeClient({
    baseUrl: "http://agentpdf.test",
    fetch: async (input: string | URL, init?: RequestInit) => {
...
test("OKofficeClient exposes artifact graph helper", async () => {
  let postedBody: unknown;
  const client = new OKofficeClient({
    baseUrl: "http://agentpdf.test",
    fetch: async (input: string | URL, init?: RequestInit) => {
...
test("OKofficeClient exposes artifact source map helper", async () => {
  let postedBody: unknown;
  const client = new OKofficeClient({
    baseUrl: "http://agentpdf.test",
    fetch: async (input: string | URL, init?: RequestInit) => {
...
test("OKofficeClient exposes context packet report helper", async () => {
  let postedBody: unknown;
  const client = new OKofficeClient({
    baseUrl: "http://agentpdf.test",
    fetch: async (input: string | URL, init?: RequestInit) => {
...
test("OKofficeClient exposes artifact bundle verify helper", async () => {
  let postedBody: unknown;
  const client = new OKofficeClient({
    baseUrl: "http://agentpdf.test",
    fetch: async (input: string | URL, init?: RequestInit) => {
...
test("OKofficeClient exposes Claude Code agent setup helper", async () => {
  let postedBody: unknown;
  const client = new OKofficeClient({
    baseUrl: "http://agentpdf.test",
    fetch: async (input: string | URL, init?: RequestInit) => {
...
test("OKofficeClient exposes Codex agent setup helper", async () => {
  let postedBody: unknown;
  const client = new OKofficeClient({
    baseUrl: "http://agentpdf.test",
    fetch: async (input: string | URL, init?: RequestInit) => {
...
test("OKofficeClient exposes Kilo Code and OpenClaw setup helpers", async () => {
  const calls: Array<{ url: string; body: unknown }> = [];
  const client = new OKofficeClient({
    baseUrl: "http://agentpdf.test",
    fetch: async (input: string | URL, init?: RequestInit) => {
...
test("OKofficeClient exposes high-frequency PDF utility wrappers", async () => {
  const calls: Array<{ url: string; body: unknown }> = [];
  const client = new OKofficeClient({
    baseUrl: "http://agentpdf.test",
    fetch: async (input: string | URL, init?: RequestInit) => {
...
test("OKofficeClient returns failed ToolResult bodies instead of hiding them", async () => {
