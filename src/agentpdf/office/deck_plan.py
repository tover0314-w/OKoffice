...
from agentpdf.office.sheet import profile_sheet_data, read_sheet_workbook
    ...
    *,
    ...
    if profile_result.status == "failed":
        return _failed(
            ...
            or AgentPDFError(code="unsupported_file_type", message="Workbook profile failed before deck planning."),
        )
