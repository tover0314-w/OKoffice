...
from agentpdf.schemas.models import AgentPDFModel
...
class PdfLocator(AgentPDFModel):
...
class WordLocator(AgentPDFModel):
...
class SheetLocator(AgentPDFModel):
...
class DeckLocator(AgentPDFModel):
...
class CodeLocator(AgentPDFModel):
...
class TimeLocator(AgentPDFModel):
...
class SourceGraphNode(AgentPDFModel):
    source_id: str
...
class SourceGraphEdge(AgentPDFModel):
    edge_id: str
    from_source_id: str
    to_source_id: str
