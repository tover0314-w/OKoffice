...
from okoffice.authoring.models import PageDocument
...
def write_raw_html_package(
    *,
    ...
    try:
        ...
        document = _raw_html_document(raw_html, title=title or "OKoffice HTML Package")
...
def _document_title(document: PageDocument) -> str:
    return document.pages[0].title if document.pages else "OKoffice Authoring"
