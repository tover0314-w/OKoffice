...
def createpdf_html_first(
    *,
    ...
    manifest_result = create_artifact_manifest(
        ...
        title=title or "OKoffice CreatePDF Artifact Manifest",
        metadata={
            "workflow_id": workflow_id,
    ...
    graph_result = build_artifact_graph(
        ...
        title=title or "OKoffice CreatePDF Artifact Graph",
    )
...
def _maybe_export_bundle(
    *,
    ...
    bundle_result = export_artifact_bundle(
        ...
        title=f"{title or 'OKoffice CreatePDF'} Audit Bundle",
        metadata={
            "workflow": TOOL_NAME,
            "workflow_id": workflow_id,
...
def _failed(
    ...
    *,
    ...
    error = failed.error or OKofficeError(
